...
SvargrondArena = {
	...
	kickTime = 600,
	kickPosition = Position(2854, 1371, 6),
	rewardPosition = Position(2825, 1355, 6),
...
local firstPit = {
	fromPos = {x = 2808, y = 1369, z = 7},
	toPos = {x = 2816, y = 1378, z = 7},
	center = {x = 2813, y = 1373, z = 7},
	pillar = {x = 2807, y = 1373, z = 7},
	tp = {x = 2807, y = 1373, z = 7},
	summon = {x = 2811, y = 1371, z = 7}
}
